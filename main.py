...
class SecurityApp(QWidget):
    ...
    def init_ui(self):
        self.sotrudnik = QLabel('ДЛЯ СОТРУДНИКОВ')

        self.pass_number_label = QLabel('Номер пропуска:')
        self.pass_number_edit = QLineEdit()
        ...
        self.guest = QLabel('ДЛЯ ПОСЕТИТЕЛЕЙ')

        self.guest_duration_label = QLabel('Продолжительность посещения:')
        self.guest_duration_edit = QLineEdit()

        self.guest_name_label = QLabel('Имя:')
        self.guest_name_edit = QLineEdit()

        self.guest_lastname_label = QLabel('Фамилия:')
        self.guest_lastname_edit = QLineEdit()
        ...
        layout.addWidget(self.pass_number_label)
        ...
        self.setWindowTitle('Система безопасности')
        self.show()
    ...
    def handle_entry(self):
        ...
        if not self.employee_data['Фамилия'].str.strip().str.lower().eq(last_name.lower()).any():
            self.show_error('Сотрудник с такой фамилией не найден.')
            return
        ...
        self.show_message(' Вход успешно зарегистрирован.')
    ...
    def guest_handle_entry(self):
        ...
        self.show_message('Вход успешно зарегистрирован.')
        # Запускаем таймер при входе гостя
    ...
    def check_guest_pass_expiry(self):
        ...
        if expired_guests:
            message = 'Время вашего пребывания истекло. Обратитесь к старшему сотруднику охранной службы.'
